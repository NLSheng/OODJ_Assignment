 ...
 * @author user
 */
public class ViewPayment extends javax.swing.JInternalFrame {
    ...
    private void Show_Table() {
        ...
        try {
            ...
            for (int i = 0; i < carLines.length; i++) {
                ...
                if (row[1].equals(customer.getUserID()) && row[7].equals("confirmed")) {
    ...
    private void initComponents() {
        ...
        confirmBookingBtn.setText("Make Payment");
        ...
        getContentPane().add(confirmBookingBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 480, 130, 40));
    ...
    private void confirmBookingBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmBookingBtnActionPerformed
        try {
            if (bookingTable.getSelectedRowCount() == 1) {
                ...
                String totalRentPrice = tableBooking.getValueAt(i, 11).toString();
                
                Booking booking = new Booking(bookingID, totalRentPrice);
                Payment payment = new Payment();
                Car car = new Car(carID, carBrand, carModel);
                Customer customer = new Customer(booking, payment, car, customerID, customerName);
                customer.makePayment(this);
                Show_Table();
